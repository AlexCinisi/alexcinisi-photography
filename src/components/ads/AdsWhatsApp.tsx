...
const WA_NUMBER = '393271249998'
const WA_MESSAGE = encodeURIComponent("Hi Alex, I'm interested in a proposal/couple session in Sicily.")
const WA_URL = `https://wa.me/${WA_NUMBER}?text=${WA_MESSAGE}`

// Inline SVG — WhatsApp icon (simple, brand-neutral)
const WhatsAppIcon = () => (
